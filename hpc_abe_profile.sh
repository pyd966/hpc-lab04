...
LTO_ENABLE="${AMSS_ENABLE_LTO:-OFF}"
...
RHS_CHI_RICCI_FUSION="${AMSS_RHS_CHI_RICCI_FUSION:-OFF}"
RHS_FIRST_CONNECTION_FUSION="${AMSS_RHS_FIRST_CONNECTION_FUSION:-OFF}"
RHS_FIRST_CONNECTION_PAIR_FUSION="${AMSS_RHS_FIRST_CONNECTION_PAIR_FUSION:-ON}"
RHS_RICCI_TILING="${AMSS_RHS_RICCI_TILING:-ON}"
RHS_RICCI_TILE_J="${AMSS_RHS_RICCI_TILE_J:-1}"
HUGEPAGE_HINT="${AMSS_ENABLE_HUGEPAGE_HINT:-OFF}"
BLOCK_FIELD_ARENA="${AMSS_ENABLE_BLOCK_FIELD_ARENA:-ON}"
RHS_SANITY_CHECK="${AMSS_RHS_SANITY_CHECK:-OFF}"
DIRECT_SYNC="${AMSS_ENABLE_OMP_DIRECT_SYNC:-ON}"
...
echo "RHS chi Ricci fusion: $RHS_CHI_RICCI_FUSION"
echo "RHS first connection fusion: $RHS_FIRST_CONNECTION_FUSION"
echo "RHS first connection pair fusion: $RHS_FIRST_CONNECTION_PAIR_FUSION"
echo "RHS Ricci tiling: $RHS_RICCI_TILING"
echo "RHS Ricci tile j: $RHS_RICCI_TILE_J"
echo "Transparent huge-page hint: $HUGEPAGE_HINT"
echo "Block field arena: $BLOCK_FIELD_ARENA"
...
./compile.sh \
    ...
    -DAMSS_ENABLE_RHS_CHI_RICCI_FUSION="$RHS_CHI_RICCI_FUSION" \
    -DAMSS_ENABLE_RHS_FIRST_CONNECTION_FUSION="$RHS_FIRST_CONNECTION_FUSION" \
    -DAMSS_ENABLE_RHS_FIRST_CONNECTION_PAIR_FUSION="$RHS_FIRST_CONNECTION_PAIR_FUSION" \
    -DAMSS_ENABLE_RHS_RICCI_TILING="$RHS_RICCI_TILING" \
    -DAMSS_RHS_RICCI_TILE_J="$RHS_RICCI_TILE_J" \
    -DAMSS_ENABLE_HUGEPAGE_HINT="$HUGEPAGE_HINT" \
    -DAMSS_ENABLE_BLOCK_FIELD_ARENA="$BLOCK_FIELD_ARENA" \
