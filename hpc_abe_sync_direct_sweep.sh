...
OUT_DIR="$ROOT_DIR/profile/abe-sync-direct-$RUN_ID"
...
OMP_THREADS="${ABE_SYNC_OMP_THREADS:-30}"
STATIC_TARGET="${ABE_SYNC_STATIC_TARGET:-24}"
MOVING_TARGET="${ABE_SYNC_MOVING_TARGET:-30}"
EVOLVE_TIME="${ABE_SYNC_TIME:-4.0}"
RUN_ORDER="${ABE_SYNC_RUN_ORDER:-pack direct direct pack}"
...
for index in "${!names[@]}"; do
    ...
    ./compile.sh \
        ...
        -DAMSS_ENABLE_OMP_DIRECT_SYNC="$value" \
...
export AMSS_BUILD_DIR="$OUT_DIR/build-pack"
