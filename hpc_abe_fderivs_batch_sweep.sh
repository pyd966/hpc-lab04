...
OUT_DIR="$ROOT_DIR/profile/abe-fderivs-batch-$RUN_ID"
...
OMP_THREADS="${ABE_BATCH_OMP_THREADS:-30}"
STATIC_TARGET="${ABE_BATCH_STATIC_TARGET:-24}"
MOVING_TARGET="${ABE_BATCH_MOVING_TARGET:-30}"
EVOLVE_TIME="${ABE_BATCH_TIME:-4.0}"
RUN_ORDER="${ABE_BATCH_RUN_ORDER:-full batch batch full}"
...
export AMSS_BUILD_DIR="$OUT_DIR/build-full"
