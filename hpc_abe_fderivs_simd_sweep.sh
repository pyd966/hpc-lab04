...
OUT_DIR="$ROOT_DIR/profile/abe-fderivs-simd-$RUN_ID"
...
for index in "${!names[@]}"; do
    ...
    echo "=== Build $name: AMSS_ENABLE_FDERIVS_SIMD=$value ==="
    ./compile.sh \
        -DAMSS_ENABLE_GPU=OFF \
        -DAMSS_ENABLE_OPENMP=ON \
        -DAMSS_ENABLE_OMP_ONLY=ON \
        -DAMSS_ENABLE_FDERIVS_SIMD="$value" \
