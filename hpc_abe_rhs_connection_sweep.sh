...
OUT_DIR="$ROOT_DIR/profile/abe-rhs-connection-$RUN_ID"
...
for value in OFF ON; do
    ...
    ./compile.sh \
        ...
        -DAMSS_ENABLE_RHS_CONNECTION_FUSION="$value" -DAMSS_ENABLE_TWOPUNCTURE_OPENMP=ON \
