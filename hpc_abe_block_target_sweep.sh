...
OUT_DIR="$ROOT_DIR/profile/abe-block-target-$RUN_ID"
...
RUN_ORDER="${ABE_GEOMETRY_RUN_ORDER:-30b 60b 60b 90b 90b 30b}"
...
names=(30b 60b 90b)
threads=(30 30 30)
static_targets=(24 60 90)
moving_targets=(30 60 90)
static_threads=(24 24 24)
moving_threads=(30 30 30)
...
export AMSS_BUILD_DIR="$OUT_DIR/build-30b"
...
printf 'sequence\tcandidate\tomps\tstatic_target\tmoving_target\tstatic_threads\tmoving_threads\tevolve_seconds\ttotal_seconds\taverage_cpus\tipc\tbranch_miss_pct\tL1D_miss_pct\tLLC_load_miss_pct\tdTLB_miss_pct\tbitwise_vs_30b\tcourse_check\n' > "$OUT_DIR/results.tsv"
