...
OUT_DIR="$ROOT_DIR/profile/abe-thread-geometry-$RUN_ID"
...
RUN_ORDER="${ABE_GEOMETRY_RUN_ORDER:-30t 60t 60t 30t}"
...
names=(30t 60t)
threads=(30 60)
static_targets=(24 48)
moving_targets=(30 60)
static_threads=(24 48)
moving_threads=(30 60)
...
export AMSS_BUILD_DIR="$OUT_DIR/build-30t"
...
printf 'sequence\tcandidate\tomps\tstatic_target\tmoving_target\tstatic_threads\tmoving_threads\tevolve_seconds\ttotal_seconds\taverage_cpus\tipc\tbranch_miss_pct\tL1D_miss_pct\tLLC_load_miss_pct\tdTLB_miss_pct\tbitwise_vs_30t\tcourse_check\n' > "$OUT_DIR/results.tsv"
