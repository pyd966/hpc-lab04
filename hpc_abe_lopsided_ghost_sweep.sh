...
OUT_DIR="$ROOT_DIR/profile/abe-lopsided-ghost-$RUN_ID"
...
for index in "${!names[@]}"; do
    ...
    ./compile.sh \
        ...
        -DAMSS_ENABLE_LOPSIDEDIFF_GHOST_ONLY="$value" \
...
printf 'sequence\tcandidate\tomps\tstatic_target\tmoving_target\tstatic_threads\tmoving_threads\tevolve_seconds\ttotal_seconds\taverage_cpus\tipc\tbranch_miss_pct\tL1D_miss_pct\tLLC_load_miss_pct\tdTLB_miss_pct\tbitwise_vs_off\tcourse_check\n' > "$OUT_DIR/results.tsv"
