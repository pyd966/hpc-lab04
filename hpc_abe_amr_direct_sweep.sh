...
OUT_DIR="$ROOT_DIR/profile/abe-amr-direct-$RUN_ID"
...
OMP_THREADS="${ABE_AMR_OMP_THREADS:-30}"
STATIC_TARGET="${ABE_AMR_STATIC_TARGET:-24}"
MOVING_TARGET="${ABE_AMR_MOVING_TARGET:-30}"
EVOLVE_TIME="${ABE_AMR_TIME:-4.0}"
RUN_ORDER="${ABE_AMR_RUN_ORDER:-base amr amr base}"
...
for index in "${!names[@]}"; do
    ...
    ./compile.sh \
        ...
        -DAMSS_ENABLE_OMP_DIRECT_AMR_TRANSFER="$value" \
